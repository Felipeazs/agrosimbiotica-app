...
const Home = () => {
    return (
        <div>
            <Hero />
            <main className="flex flex-col justify-around mt-200 bg-secondary text-white skew-y-6">
                <div className="flex flex-row justify-center items-center mb-40 -skew-y-6">
                    <div className="w-1/2">
                        ...
                        <p className="text-xl text-end px-40">
                            Si eres productor de residuos orgánicos, deberás logearte cargando solo
                            el nombre de tu empresa, tu actividad, y que residuos tienes. De esta
                            manera entras a nuestra base de datos para generar conexiones. Si buscas
                            materiales para tus procesos, busca dentro de nuestra oferta lo que
                            necesites, y nosotros te lo llevaremos a dónde estés.
                        </p>
                    </div>
                ...
                <div className="flex flex-row justify-center items-center mb-40 -skew-y-6">
                    <div className="">
                        <p className="text-2xl text-end p-40">
                            ...
                            podrás conectar con nuevas posibilidades de negocio, podrás visualizar
                            tus transacciones, los ahorros y el impacto positivo que está generando
